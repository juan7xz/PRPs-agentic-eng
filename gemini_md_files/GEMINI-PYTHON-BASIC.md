...
This file provides comprehensive guidance to Gemini CLI when working with Python code in this repository.
...
Never include Gemini CLI, or written by gemini code in commit messages
